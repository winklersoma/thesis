...
def logdelay(drug_0=2.3869, k_c=(0, 1, 0), delta=1.83281, protocol=[0, 24, 48, 72, 96]):
    ...
    end_time = protocol[-1] + 72 if protocol[-1] != 0 else 100
    time_step = 0.05
    drug_step = 0.05
    Data = []
...
plt.xlabel('Time')
# plt.savefig('Protocol_demo', dpi=300)
plt.show()
